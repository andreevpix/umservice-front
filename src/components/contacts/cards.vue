<template>
  <div class="container cards_container">
    <ul class="cards_list">
      <li v-for="card in dataCards" :key="card.id" class="cards_list__item">
        <span class="cards_list__item_title">{{ card.title }}</span>
        <div class="cards_list__item_data">
          <p
            v-for="contact in card.data"
            :key="contact.id"
          ...
          >
            ...
            <span v-else>
              ...
              <span class="cards_list__item_data_contact_text">
                {{ contact.text }}
              </span>
            </span>
          </p>
        ...
        <NuxtLink
          ...
          external
        >
          <span class="cards_list__item_download_name">
            {{ card.document.name }}
          </span>
          <span
        ...
        <span class="cards_list__item_icon" v-html="card.icon" />
      </li>
    </ul>
  </div>
</template>
